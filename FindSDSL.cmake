...
if ( NOT DEFINED SDSL_ROOT_DIR )
  if (WIN32)
    ...
    get_filename_component ( BASEDIR "/usr/local/sdsl/" REALPATH )
  endif()
...
if ( SDSL_ROOT_DIR )
    ...
    #-------- Locate Library	
     set ( OK_LIB "0" )		
  	_FIND_FILE ( LIST_LIB SDSL_LIB_DIR "sdsl_${MSVC_YEAR}x64.lib" "libsdsl.so" OK_LIB )	        
	_FIND_FILE ( LIST_LIB SDSL_LIB_DIR "sdsl_${MSVC_YEAR}x64d.lib" "libsdsld.so" OK_LIB )	        	
	message ( STATUS "  Searching for SDSL LIBRARY: sdsl_${MSVC_YEAR}x64.lib / libsdsl.so" )
	if ( OK_LIB EQUAL 2 ) 
