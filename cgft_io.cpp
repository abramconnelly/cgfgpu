...
#else
	static void _read_skip ( size_t sz, FILE* fp ) {
...
#else
  _read_skip ( tilepath->LoqTileStepHomSize, fp );
  _read_skip ( tilepath->LoqTileVariantHomSize, fp  );
  _read_skip ( tilepath->LoqTileNocSumHomSize, fp  );
  _read_skip ( tilepath->LoqTileNocStartHomSize, fp  );
  _read_skip ( tilepath->LoqTileNocLenHomSize, fp  );

  _read_skip ( tilepath->LoqTileStepHetSize, fp  );
  _read_skip ( tilepath->LoqTileVariantHetSize, fp  );
  _read_skip ( tilepath->LoqTileNocSumHetSize, fp  );
  _read_skip ( tilepath->LoqTileNocStartHetSize, fp  );
  _read_skip ( tilepath->LoqTileNocLenHetSize, fp  );
